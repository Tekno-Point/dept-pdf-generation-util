...
public interface GenerateHealthPDF {
    byte[] generateHyperTensionPDF(String applicationNumber, String nameOfLifeAssured, JsonObject hypertension, boolean isOmniDoc, String placeName, String primaryMobileNo, String countryCode, JsonObject imagesJson);
