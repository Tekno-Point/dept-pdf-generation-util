...
import com.pdfGeneration.service.MoneyBalancePDFService;
...
@Service
public class MoneyBalancePDFServiceImpl extends NomineeAddendumPDF implements MoneyBalancePDFService {
    ...
    public MoneyBalancePDFServiceImpl(PDFUtility pdfUtility, JsonUtility jsonUtility, OnlineUtility onlineUtility) {
    ...
    @Override
    public byte[] moneyBalanceForm(String request) {
        ...
        try {
            ...
            pdfDocumentInfo.setTitle("Money Balance Application Form");
            ...
            if (agentCode.length() > 0) {
                ...
                firstBlockRight.addCell(new Cell().add(""));
            }
...
//                    + jsonUtility.getJsonKeyValue("addressline3", primaryPersonalDetailObj);
          ...
          /*  addressBlock = new Table(1);
            ...
            if (permanentaddressline1.length() > 0) {
                Table address1Block = codeTableForEmail(permanentaddressline1, pointColumnWidths);
            ...
            if (permanentaddressline2.length() > 0) {
                Table address2Block = codeTableForEmail(permanentaddressline2, pointColumnWidths);
            ...
            if (permanentaddressline3.length() > 0) {
                Table address3Block = codeTableForEmail(permanentaddressline3, pointColumnWidths);
            ...
            if (permanentlandmark.length() > 0) {
                Table address3Block = codeTableForEmail(permanentlandmark, pointColumnWidths);
                addressBlock.addCell(new Cell().add(address3Block).setBorder(Border.NO_BORDER));
            }
            ...
            proposerDetails.addCell(proposerMergedcell).setVerticalAlignment(VerticalAlignment.MIDDLE);*/
            addressBlock = new Table(1);
            addressBlock.addCell(new Cell().add(pdfUtility.createDataTable(permanentaddressline1,"0000000000000000000000000000000000000000")).setBorder(Border.NO_BORDER));
            addressBlock.addCell(new Cell().add(pdfUtility.createDataTable(permanentaddressline2,"0000000000000000000000000000000000000000")).setBorder(Border.NO_BORDER));
            addressBlock.addCell(new Cell().add(pdfUtility.createDataTable(permanentaddressline3,"0000000000000000000000000000000000000000")).setBorder(Border.NO_BORDER));
            addressBlock.addCell(new Cell().add(pdfUtility.createDataTable(permanentlandmark,"0000000000000000000000000000000000000000")).setBorder(Border.NO_BORDER));
            addressBlock.addCell(new Cell().add(pdfUtility.createDataTable(permanentcity,"0000000000000000000000000000000000000000")).setBorder(Border.NO_BORDER));
            addressBlock.addCell(new Cell().add(pdfUtility.createDataTable(permanentstate,"0000000000000000000000000000000000000000")).setBorder(Border.NO_BORDER));
            proposerMergedcell.add(addressBlock).setBorder(Border.NO_BORDER);
            proposerDetails.addCell(proposerMergedcell).setVerticalAlignment(VerticalAlignment.MIDDLE);
            ...
            if (!countryCode.isEmpty()) {
                ...
                contactTable.addCell(new Cell().add(""));
            }
...
//                    pointColumnWidths[i] = 20F;
//                }
//                if (!lifeAssuredFullName.isEmpty()) {
...
//            table.addCell(new Cell().add(p).setVerticalAlignment(VerticalAlignment.MIDDLE));
            ...
            if (dd.length() > 0) {
                ...
                dateOpted.addCell(new Cell().add(""));
            }
            dateOpted.addCell(new Cell().add(""));
...
//            p.add("\n\n");
            ...
            Table secondaryLifeAssuredDetails = this.getSecondaryLifeAssuredDetails(userData.get("applicationNumber").getAsString(),imgUnchecked,innerProposer);
...
/*            medicalLifestyleQ = new Table(new float[]{750F, 150F});
            ...
            if (heightInCM.length() > 0) {
                ...
                bodyDetails.addCell(new Cell().add(""));
            }
            ...
            femaleLifeAssured.addCell(new Cell().add(p).setBorder(Border.NO_BORDER));
            femaleLifeAssured.addCell(new Cell().add("If yes duration in weeks: ").setBorder(Border.NO_BORDER));
            femaleLifeAssured.addCell(new Cell().add(""));
            femaleLifeAssured.addCell(new Cell().add("b. Date of last delivery:  ").setBorder(Border.NO_BORDER));
            femaleLifeAssured.addCell(new Cell().add(""));
            femaleLifeAssured.addCell(new Cell().add("c. Please state any complications during pregnancy?").setBorder(Border.NO_BORDER));
            femaleLifeAssured.addCell(new Cell().add(""));
            ...
            if (isOmniDoc) {
                ...
                if (countryCode.equalsIgnoreCase("91")) {
                    ...
                    p.add(new Text(onlineUtility.maskMobileNumber(mobileNo)).setBold());
                    p.add("\n\n");
                } else {
            ...
            String laDate = currentDate.format(formatters);
            String witnessName = "";
            ...
            String proposerDate = String.valueOf(laDate);
...
//            JsonObject haveDisabilityObj = jsonUtility.getJsonObjectByKey("have_disability", medicalDisabilityObj);
            ...
            if(nomineeList.size() > 1){
                Table nomineeAddendum = this.generateNomineePDF(pdfUtility, jsonUtility, jsonUtility.getJsonKeyValue("applicationNumber", userData), nomineeList);
