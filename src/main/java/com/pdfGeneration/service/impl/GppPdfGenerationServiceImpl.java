...
@Service
public class GppPdfGenerationServiceImpl  implements GppPdfGenerationService {
    ...
    public GppPdfGenerationServiceImpl(PDFUtility pdfUtility, JsonUtility jsonUtility) {
    ...
    @Override
    public byte[] generateGppPdf(String gppPdfReq) {

        ByteArrayOutputStream baos = new ByteArrayOutputStream();
        try {

            JsonObject userData = jsonUtility.getJsonObject(gppPdfReq);
...
//                    + jsonUtility.getJsonKeyValue("addressline3", primaryPersonalDetailObj);
            ...
            contactTable.addCell(new Cell().add("Email ID:  ").setBorder(Border.NO_BORDER).setTextAlignment(TextAlignment.LEFT));
            ...
            if (landLine.length() > 0) {
                tableCodes = codeTable(landLine, pointColumnWidths);
                contactTable.addCell(new Cell().add(tableCodes).setBorder(Border.NO_BORDER));
            } else {
                contactTable.addCell(new Cell().add("").setBorder(Border.NO_BORDER));
            }
            ...
            JsonObject primaryAgeProofAll = jsonUtility.getJsonObjectByKey("ageProof-all", primaryDocumentDetailObj);
            String primaryAgeDocType = jsonUtility.getJsonKeyValue("documentType", primaryAgeProofAll);
            ...
            JsonObject primaryIdProof = jsonUtility.getJsonObjectByKey("idProof", primaryDocumentDetailObj);
            String primaryIdDocType = jsonUtility.getJsonKeyValue("documentType", primaryIdProof);
            ...
            contactTable.addCell(new Cell().add("Identity Proof: ").setTextAlignment(TextAlignment.LEFT).setBorder(Border.NO_BORDER));
            contactTable.addCell(new Cell().add(new Paragraph(identityProof).setUnderline()).setBorder(Border.NO_BORDER));
            contactTable.addCell(new Cell().add("Address Proof:    ").setTextAlignment(TextAlignment.LEFT).setBorder(Border.NO_BORDER));
            contactTable.addCell(new Cell().add(new Paragraph(addressProof).setUnderline()).setBorder(Border.NO_BORDER));
            contactTable.addCell(new Cell().add("Age Proof:    ").setTextAlignment(TextAlignment.LEFT).setBorder(Border.NO_BORDER));
            ...
            //otherDetails.addCell(new Cell().add(new Cell().add(panCardNo).setUnderline()).setBorder(Border.NO_BORDER));
...
//            }
            ...
            otherDetails.addCell(new Cell().add(myself ? "Self" : buyFor).setUnderline().setBorder(Border.NO_BORDER));
            ...
            pointColumnWidths = new float[lifeAssuredFullName.length()];
            for (int i = 0; i < lifeAssuredFullName.length(); i++) {
                pointColumnWidths[i] = 20F;
            }
            if (lifeAssuredFullName.length() > 0) {
                tableCodes = codeTable(lifeAssuredFullName, pointColumnWidths);
                proposerMergedcell.add(tableCodes).setBorder(Border.NO_BORDER);
            } else {
                proposerMergedcell.add(new Paragraph("")).setBorder(Border.NO_BORDER);
            }
            ...
            proposerMergedcell = new Cell(1, 2);
            pointColumnWidths = new float[]{200F, 450F, 220F, 350F};
            ...
            Table nomineeDetails = new Table(6);
            ...
            nomineeDetails.addCell("Appointee's Name");
...
//                    appointeeDetails.addCell(jsonUtility.getJsonKeyValue("appointeeAddress", objNom));
                    String permanentAddress = Stream.of(
                    ...
                    appointeeDetails.addCell(permanentAddress);
                } else {
                    appointeeDetails.addCell("");
                    appointeeDetails.addCell("");
                    appointeeDetails.addCell("");
                    appointeeDetails.addCell("");
                    appointeeDetails.addCell("");
            ...
            p.add("     No      ");
            p.add(imgUnchecked);
            p.add("     (Applicable only for IndiaFirst Life Smart Pay Plan)");
            table.addCell(new Cell().add(p).setBorder(Border.NO_BORDER));

            /////
            p = new Paragraph("(Please select the appropriate option for ");
            p.add(new Text(" IndiaFirst Life Little Champ Plan, IndiaFirst Life Guaranteed Monthly Income Plan, IndiaFirst Life Smart Pay Plan, IndiaFirst Life Long Guaranteed Income " + "Plan, IndiaFirst Life Guaranteed Benefit Plan, IndiaFirst Life Mahajeevan Plus Plan &IndiaFirst Life Guarantee Of Life Dreams Plan").setBold());
            p.add(")");
            //table.addCell(new Cell().add(p).setBorder(Border.NO_BORDER));
            ...
            p = new Paragraph("For ");
            p.add(new Text("IndiaFirst Life Guaranteed Monthly Income Plan").setBold());
            ...
            Table dateOpted = new Table(new float[]{50F, 20F, 50F});
            ...
            dateOpted.addCell(new Cell().add("DD").setBorder(Border.NO_BORDER));
            dateOpted.addCell(new Cell().add("").setBorder(Border.NO_BORDER));
            dateOpted.addCell(new Cell().add("MM").setBorder(Border.NO_BORDER));
...
//            p = new Paragraph(new Text("IndiaFirst Life Guaranteed Protection Plus Plan ").setBold());
...
/*
            deathBenefitOptions = new Table(new float[]{700F, 300F});
            deathBenefitOptions.addCell(new Cell().add("Death Benefit Option for IndiaFirst Life Wealth Maximizer Plan, IndiaFirst Money Balance Plan and " + "IndiaFirst Smart Save Plan").setBold().setBorder(Border.NO_BORDER).setVerticalAlignment(VerticalAlignment.MIDDLE));
            p = new Paragraph();
            p.add(imgUnchecked);
            p.add("     Income (5 Years)       ");
            p.add(imgUnchecked);
...
*/
            ...
            Table fundsDetails = new Table(new float[]{300F, 100F, 300F, 100F, 300F, 100F});
            fundsDetails.addCell(new Cell(1, 6).add("Funds (Funds total to be 100 %)").setTextAlignment(TextAlignment.CENTER).setBorder(Border.NO_BORDER));
            fundsDetails.addCell(new Cell().add("Equity1** (ULIF009010910EQUTY1FUND143)"));
            fundsDetails.addCell(new Cell().add("   "));
            fundsDetails.addCell(new Cell().add("Value (ULIF013010910VALUEFUND0143)"));
            fundsDetails.addCell(new Cell().add("   "));
            fundsDetails.addCell(new Cell().add("Liquid1 (ULIF014010910LIQUID1FND143)"));
            fundsDetails.addCell(new Cell().add("   "));
            fundsDetails.addCell(new Cell().add("Debt1** (ULIF010010910DEBT01FUND143)"));
            fundsDetails.addCell(new Cell().add("   "));
            fundsDetails.addCell(new Cell().add("Balanced1 (ULIF011010910BALAN1FUND143)"));
            fundsDetails.addCell(new Cell().add("   "));
            fundsDetails.addCell(new Cell().add("Index Tracker (ULIF012010910INDTRAFUND143 )"));
            fundsDetails.addCell(new Cell().add("   "));
            fundsDetails.addCell(new Cell().add("Equity Elite Opportunities (ULIF020280716EQUELITEOP143)"));
            fundsDetails.addCell(new Cell().add("   "));
            fundsDetails.addCell(new Cell().add("Dynamic Asset Allocation (ULIF015080811DYAALLFUND143)"));
            fundsDetails.addCell(new Cell().add("   "));
            fundsDetails.addCell(new Cell().add("   "));
            fundsDetails.addCell(new Cell().add("   "));
            fundsDetails.addCell(new Cell(1, 6).add("***Equity1 and Debt1 are the only available fund options under IndiaFirst Life Money Balance Plan. Liquid 1 fund is not available at inception." + "For Fund Transfer Strategy, please select one Equity Oriented Fund and one Debt Oriented Fund."));
            // fundsDetails.addCell(new Cell(1, 6).add("Note: The first three months premium is to be paid as first installment for the monthly mode option (not applicable for pure protection plans). Any cash/cheque/DD payment made towards first or renewal premium is deemed to be " + "received by ”IndiaFirst Life Insurance Company Ltd.” only when the same has been received by any of its offices or its authorised banking partners or collection point and after an official printed receipt is issued by the Company. " + "Cheques must be drawn only in favour of IndiaFirst Life Insurance Company Ltd. (Application no. for first premium/ policy no. for renewal premium should be written behind the cheque). Note: The collections points/ centers for " + "accepting payment in cash/ cheque/ DD will be as specified by the Company from time to time."));
            table.addCell(new Cell().add(fundsDetails).setBorder(Border.NO_BORDER));
            p=new Paragraph("Note: The first three months premium is to be paid as first installment for the monthly mode option (not applicable for pure protection plans). Any cash/cheque/DD payment made towards first or renewal premium is deemed to be received by ”IndiaFirst Life Insurance Company Ltd.” only when the same has been received by any of its offices or its authorised banking partners or collection point and after an official printed receipt is issued by the Company.Cheques must be drawn only in favour of IndiaFirst Life Insurance Company Ltd. (Application no. for first premium/ policy no. for renewal premium should be written behind the cheque). Note: The collections points/ centers for accepting payment in cash/ cheque/ DD will be as specified by the Company from time to time.");
            p.add("\n\n");
            ...
            pointColumnWidths = new float[]{200F, 200F};
            ...
            lifeAssuredDetails = new Table(2);
            lifeAssuredDetails.setBorder(Border.NO_BORDER);
            ...
            if (buyFor.equalsIgnoreCase("Spouse") && planCode.equalsIgnoreCase("T56")) {
                ...
                String lifeAssuredDate = dateTimeFormatter.format(birthDate);
                pointColumnWidths = new float[lifeAssuredDate.length()];
                ...
                for (int i = 0; i < lifeAssuredDate.length(); i++) {
                    pointColumnWidths[i] = 20F;
                }
                if (lifeAssuredDate.length() > 0) {
                    tableCodes = codeTable(lifeAssuredDate, pointColumnWidths);
                    contactTable.addCell(new Cell().add(tableCodes).setVerticalAlignment(VerticalAlignment.MIDDLE).setBorder(Border.NO_BORDER));
                } else {
                    contactTable.addCell(new Cell().add("").setVerticalAlignment(VerticalAlignment.MIDDLE).setBorder(Border.NO_BORDER));
                }
                ...
                p.add("(Please provide Form 60, if PAN is not available)");
                otherDetails.addCell(new Cell().add(p).setTextAlignment(TextAlignment.CENTER).setBorder(Border.NO_BORDER));
                //otherDetails.addCell(new Cell().add(new Cell().add(jsonUtility.getJsonKeyValue("pancard", secondaryPersonalDetailObj)).setUnderline()).setBorder(Border.NO_BORDER));
                pointColumnWidths = new float[panCardNo.length()];
                for (int i = 0; i < panCardNo.length(); i++) {
                    pointColumnWidths[i] = 20F;
                }
            ...
            proposerMergedcell = new Cell(1, 2);
            p = new Paragraph("Mode selected will be used by the Company to pay the Life Assured/ Nominee according to the terms of the plan. If none of the below electronic payout option is chosen, the Company reserves the right to use any alternative payout option.");
            proposerMergedcell.add(p);
            proposerMergedcell.setBorder(Border.NO_BORDER);
            ...
            paymentDetails.addCell(new Cell().add("ECS: ").setBorder(Border.NO_BORDER));
            if (ecsStatus.equalsIgnoreCase("success")) {
                paymentDetails.addCell(new Cell().add(imgUnchecked).setBorder(Border.NO_BORDER));
            } else {
                paymentDetails.addCell(new Cell().add(imgChecked).setBorder(Border.NO_BORDER));
            }
            paymentDetails.addCell(new Cell().add("Direct Credit (Bank of Baroda and Union Bank of India): ").setBorder(Border.NO_BORDER));
            paymentDetails.addCell(new Cell().add(imgUnchecked).setBorder(Border.NO_BORDER));
            paymentDetails.addCell(new Cell().add("NEFT: ").setBorder(Border.NO_BORDER));
            paymentDetails.addCell(new Cell().add(imgUnchecked).setBorder(Border.NO_BORDER));
            paymentDetails.addCell(new Cell().add("Bank Name: ").setBorder(Border.NO_BORDER));
            pointColumnWidths = new float[bankName.length()];
            for (int i = 0; i < bankName.length(); i++) {
                pointColumnWidths[i] = 20F;
            }
            tableCodes = codeTable(bankName, pointColumnWidths);
            paymentDetails.addCell(new Cell().add(tableCodes).setBorder(Border.NO_BORDER));
            paymentDetails.addCell(new Cell().add("Account Type: ").setBorder(Border.NO_BORDER));
            p = new Paragraph();
            ...
            p.add("     Savings     ");
            paymentDetails.addCell(new Cell().add(p).setBorder(Border.NO_BORDER));
            paymentDetails.addCell(new Cell().add("Branch Name:  ").setBorder(Border.NO_BORDER));
            paymentDetails.addCell(new Cell().add(new Paragraph(branchName).setUnderline()).setBorder(Border.NO_BORDER));
            paymentDetails.addCell(new Cell().add("Bank Account No. : ").setBorder(Border.NO_BORDER));
            ...
            if (accountNo.length() > 0) {
                ...
                paymentDetails.addCell(new Cell().add(new Paragraph("")).setBorder(Border.NO_BORDER));
            }
            ...
            paymentDetails.addCell(new Cell().add("Customer’s Name as per the Bank Account.: ").setBorder(Border.NO_BORDER));
            ...
            table.addCell(new Cell().add(paymentDetails).setBorder(Border.NO_BORDER));
            p = new Paragraph();
            p.add(new Text("Please provide a cancelled copy of your cheque if any of the above option is selected.").setBold());
            p.add(new Text("\nDisclaimer: ").setBold());
            p.add("In case of non credit to my bank account with/without assigning any reasons thereof or if the transaction is delayed or not credited at all for reasons of incomplete/incorrect information, I will not hold IndiaFirst Life " + "Insurance Co. Ltd. responsible. Further, the Company reserves the right to use any alternative payout option including demand draft/payable at par cheque in spite of opting for the direct credit option.");
            table.addCell(new Cell().add(p).setBorder(Border.NO_BORDER));
            ...
            Table familyHistory = new Table(4);
            ...
            insuranceDetails.addCell(new Cell().add("Parents’/ Husband’s insurance details - total sum insured (Rs.): ").setBorder(Border.NO_BORDER));
            ...
            headingCell = new Cell();
            headingCell.setBackgroundColor(Color.GRAY, 100);
            p = new Paragraph("10b. Lifestyle questions and personal medical history of the Secondary Life to be Assured \n(If 'Yes', please encircle the activity/ ailment/ disease) If Joint Life option is chosen. Only applicable for IndiaFirst Life Guaranteed Protection Plus Plan");
            p.setBold();
            p.setFontKerning(FontKerning.YES);
            p.setFontColor(Color.WHITE);
            headingCell.add(p);
            ...
            table.addCell(new Cell().add(p).setBorder(Border.NO_BORDER));
            p = new Paragraph("I hereby give my consent to the Company to carry out due diligence in respect of information, as provided by me in the proposal form, including AML-eKYC verification, and also to store/share the data/information " + "with government agencies/statutory authorities/entities as authorized by the regulator – IRDAI for necessary verification purposes and/or policy servicing purpose.");
            table.addCell(new Cell().add(p).setBorder(Border.NO_BORDER));

            p=new Paragraph("Having gone through the “Needs Analysis” process, I hereby confirm that the recommended product and its features have been explained to my satisfaction, and it matches my current insurance needs.");
            table.addCell(new Cell().add(p).setBorder(Border.NO_BORDER));

            p=new Paragraph("I/We hereby give consent to the Company for obtaining/downloading CKYC record from Central KYC Records Registry. I/We hereby give consent to the Company for obtaining/downloading KYC details/ from government agencies/ entities as authorized by the regulator/ statutory authorities like Passport Seva, Parivahan Sewa, Election Commission of India.");
            table.addCell(new Cell().add(p).setBorder(Border.NO_BORDER));

            p = new Paragraph();
            p.add(new Text("NRI/PIO declaration: ").setBold());
            p.add("By providing consent through OTP on the application form I hereby confirm that NRI/PIO details provided by me / us in the questionnaire are correct and to the best of my knowledge. By feeding in the said " + "number in the system, I hereby acknowledge the above declaration in its entirety and the same would create a legally binding agreement between the Company and me.");
            table.addCell(new Cell().add(p).setBorder(Border.NO_BORDER));
            p = new Paragraph();
            p.add(new Text("Digital Policy Document declaration: ").setBold());
            p.add(" I/We hereby give my consent to receive all communications and policy document via email from IndiaFirst Life Insurance Company Limited.");
            table.addCell(new Cell().add(p).setBorder(Border.NO_BORDER));
...
//            p.add("\n");
            ...
            signatureDeclarants.addCell(new Cell().add("Signature:").setBorder(Border.NO_BORDER));
            ...
            p.add("I certify that the product applied for by me and the contents of the proposal form have been clearly explained to me and I have fully understood them. I further certify that the replies in the proposal form have been recorded as " + "per the information provided by me.");
            table.addCell(new Cell().add(p).setBorder(Border.NO_BORDER));
            ...
            table.addCell(new Cell().add(p).setBorder(Border.NO_BORDER));
            Table uinList = new Table(new float[]{400F, 500F, 400F});
            uinList.addCell(new Cell().add("• UIN for IndiaFirst Life Money Balance Plan 143L017V06").setBorder(Border.NO_BORDER));
            uinList.addCell(new Cell().add("• UIN for IndiaFirst Smart Save Plan 143L010V04").setBorder(Border.NO_BORDER));
            uinList.addCell(new Cell().add("• UIN for IndiaFirst Maha Jeevan Plan 143N018V05").setBorder(Border.NO_BORDER));
            uinList.addCell(new Cell().add("• UIN for IndiaFirst Term Rider 143B001V02").setBorder(Border.NO_BORDER));
            uinList.addCell(new Cell().add("• UIN for IndiaFirst Simple Benefit Plan 143N019V03").setBorder(Border.NO_BORDER));
            uinList.addCell(new Cell().add("• UIN for IndiaFirst Life Plan 143N007V03").setBorder(Border.NO_BORDER));
            uinList.addCell(new Cell().add("• UIN for IndiaFirst Anytime Plan 143N009V02").setBorder(Border.NO_BORDER));
            uinList.addCell(new Cell().add("• UIN for IndiaFirst Life Wealth Maximizer Plan 143L029V04").setBorder(Border.NO_BORDER));
            uinList.addCell(new Cell().add("• UIN for IndiaFirst Life Cash Back Plan 143N024V04").setBorder(Border.NO_BORDER));
            uinList.addCell(new Cell().add("• UIN for IndiaFirst Life Little Champ Plan 143N035V01").setBorder(Border.NO_BORDER));
            uinList.addCell(new Cell().add("• UIN for IndiaFirst Life Guaranteed Monthly Income Plan 143N047V01").setBorder(Border.NO_BORDER));
            uinList.addCell(new Cell().add("• UIN for IndiaFirst Life Smart Pay Plan 143N051V03").setBorder(Border.NO_BORDER));
            uinList.addCell(new Cell().add("• UIN for IndiaFirst Life Waiver of Premium Rider 143B017V01").setBorder(Border.NO_BORDER));
            uinList.addCell(new Cell().add("• UIN for IndiaFirst Life Long Guaranteed Income Plan 143N054V05").setBorder(Border.NO_BORDER));
            //uinList.addCell(new Cell().add("").setBorder(Border.NO_BORDER));
            uinList.addCell(new Cell().add("• UIN for IndiaFirst Life Guaranteed Benefit Plan 143N056V06").setBorder(Border.NO_BORDER));
            uinList.addCell(new Cell().add("• UIN for IndiaFirst Life Guaranteed Protection Plus Plan 143N069V01").setBorder(Border.NO_BORDER));
            uinList.addCell(new Cell().add("• UIN for IndiaFirst Life Fortune Plus Plan 143N065V02").setBorder(Border.NO_BORDER));
            uinList.addCell(new Cell().add("• UIN for IndiaFirst Life Mahajeevan Plus Plan 143N059V02").setBorder(Border.NO_BORDER));
            uinList.addCell(new Cell().add("• UIN for IndiaFirst Life Guaranteed Single Premium Plan 143N068V03").setBorder(Border.NO_BORDER));
            // uinList.addCell(new Cell().add("").setBorder(Border.NO_BORDER));
            uinList.addCell(new Cell(1,2).add("• UIN for IndiaFirst Life Guarantee Of Life Dreams Plan 143N080V01").setBorder(Border.NO_BORDER));
