...
@Service
public class SppPDFServiceImpl extends NomineeAddendumPDF implements SppPDFService {
    ...
    public SppPDFServiceImpl(PDFUtility pdfUtility, JsonUtility jsonUtility) {
        this.pdfUtility = pdfUtility;
        this.jsonUtility = jsonUtility;
    }

    @Override
    public byte[] generateSppPlusPdf(String sppPdfReqObj) {
        ByteArrayOutputStream baos = new ByteArrayOutputStream();
        try {
            JsonObject userData = jsonUtility.getJsonObject(sppPdfReqObj);
            ...
            String yesKey = "  Yes  ";
            String noKey = "  No  ";
            JsonObject primaryBankObj = jsonUtility.getJsonObjectByKey(primaryKey, bankDetailObj);

            JsonObject primaryPersonalDetailObj = jsonUtility.getJsonObjectByKey(primaryKey, personalDetailObj);
            JsonObject secondaryPersonalDetailObj = jsonUtility.getJsonObjectByKey(secondaryKey, personalDetailObj);
            JsonObject primaryEmploymentDetailObj = jsonUtility.getJsonObjectByKey(primaryKey, employmentDetailObj);
            JsonObject secondaryEmploymentDetailObj = jsonUtility.getJsonObjectByKey(secondaryKey, employmentDetailObj);
            JsonObject primaryFatcaDetailObj = jsonUtility.getJsonObjectByKey(primaryKey, fatcaDetailObj);
            JsonObject secondaryFatcaDetailObj = jsonUtility.getJsonObjectByKey(secondaryKey, fatcaDetailObj);
            JsonObject primaryOtherDetailObj = jsonUtility.getJsonObjectByKey(primaryKey, otherDetailObj);
            JsonObject secondaryOtherDetailObj = jsonUtility.getJsonObjectByKey(secondaryKey, otherDetailObj);
            JsonObject primaryDocumentDetailObj = jsonUtility.getJsonObjectByKey(primaryKey, documentDetailObj);
            JsonObject secondaryDocumentDetailObj = jsonUtility.getJsonObjectByKey(secondaryKey, documentDetailObj);

            JsonObject primaryHealthObj = jsonUtility.getJsonObjectByKey(primaryKey, healthDetailObj);
            JsonObject secondaryHealthObj = jsonUtility.getJsonObjectByKey(secondaryKey, healthDetailObj);
            JsonObject primaryLifestyleObj = jsonUtility.getJsonObjectByKey(primaryKey, lifestyleDetailObj);
            JsonObject secondaryLifestyleObj = jsonUtility.getJsonObjectByKey(secondaryKey, lifestyleDetailObj);
            JsonObject primaryMedicalObj = jsonUtility.getJsonObjectByKey(primaryKey, medicalDetailObj);
            JsonObject secondaryMedicalObj = jsonUtility.getJsonObjectByKey(secondaryKey, medicalDetailObj);
            ...
            firstBlockRight.addCell(new Cell().add(pdfUtility.createDataTable(agentCode,"00000000")).setBorder(Border.NO_BORDER).setTextAlignment(TextAlignment.LEFT));
            firstBlockRight.addCell(new Cell().add("Branch Code: ").setBorder(Border.NO_BORDER));
            firstBlockRight.addCell(new Cell().add(pdfUtility.createDataTable(branchCode,"00000000")).setBorder(Border.NO_BORDER));
            ...
            firstBlockRight.addCell(new Cell().add(pdfUtility.createDataTable(branchManagerCode,"00000000")).setBorder(Border.NO_BORDER));

            firstBlockRight.addCell(new Cell().add("BDM / RM Code: ").setBorder(Border.NO_BORDER));
            firstBlockRight.addCell(new Cell().add(pdfUtility.createDataTable(rmCode,"00000000")).setBorder(Border.NO_BORDER));

            firstBlockRight.addCell(new Cell().add("Channel Code: ").setBorder(Border.NO_BORDER));
            firstBlockRight.addCell(new Cell().add(pdfUtility.createDataTable(channelCode,"00000000")).setBorder(Border.NO_BORDER));

            firstBlockRight.addCell(new Cell().add("BDM Mobile No. ").setBorder(Border.NO_BORDER));
            firstBlockRight.addCell(new Cell().add(pdfUtility.createDataTable(dbmMobile,"00000000")).setBorder(Border.NO_BORDER));


            Cell others = new Cell(1, 4);
            p = new Paragraph(new Text("Bancassurance/ Agency/ Broker/ Corporate Agency/ Direct Sales/ Marketing Associate, Any Others (pls specify): ").setFontSize(6f));
            ...
            JsonObject indiaFirstStaffObj = jsonUtility.getJsonObjectByKey("indiaFirstStaff", primaryEmploymentDetailObj);
            String staffStatus = jsonUtility.getJsonKeyValue(statusKey, indiaFirstStaffObj);
            ...
            proposerMergedcell.add(pdfUtility.createDataTable(fullName,"000000000000")).setBorder(Border.NO_BORDER);
            ...
            innerProposer.addCell(new Cell().add(pdfUtility.createDataTable("","00000000")).setBorder(Border.NO_BORDER));
            ...
            addressBlock.addCell(new Cell().add(pdfUtility.createDataTable(address1, "000000000000000000000000000000000000000000")).setBorder(Border.NO_BORDER));
            addressBlock.addCell(new Cell().add(pdfUtility.createDataTable(address2, "000000000000000000000000000000000000000000")).setBorder(Border.NO_BORDER));
            addressBlock.addCell(new Cell().add(pdfUtility.createDataTable(address3, "000000000000000000000000000000000000000000")).setBorder(Border.NO_BORDER));
            addressBlock.addCell(new Cell().add(pdfUtility.createDataTable(landmark,"000000000000000000000000000000000000000000")).setBorder(Border.NO_BORDER));
            addressBlock.addCell(new Cell().add(pdfUtility.createDataTable(city, "000000000000000000000000000000000000000000")).setBorder(Border.NO_BORDER));
...
//            contactTable.addCell(new Cell().add("").setVerticalAlignment(VerticalAlignment.MIDDLE).setBorder(Border.NO_BORDER).setTextAlignment(TextAlignment.CENTER));
            ...
            contactTable.addCell(new Cell(1, 4).add(p).setBorder(Border.NO_BORDER).setVerticalAlignment(VerticalAlignment.MIDDLE));
            ...
            addressProofMap.put("VOTERSID", "Voter Id Card");
            ...
            idProofMap.put("VOTERSID", "Voter Id Card");
            ...
            String primaryAgeType = jsonUtility.getJsonKeyValue("documentType", jsonUtility.getJsonObjectByKey("ageProof", primaryDocumentDetailObj));
            ...
            if (isOmniDoc && ageProofMap.containsKey(primaryAgeDocType)) {
                ageProof = primaryAgeDocType.isEmpty() ? ageProofMap.get(primaryAgeType) : ageProofMap.get(primaryAgeDocType);
            }
            ...
            otherDetails.addCell(new Cell().add(new Paragraph(myself ? "Self" : buyFor).setUnderline()).setBorder(Border.NO_BORDER));
            ...
            p = new Paragraph();
            if (jsonUtility.getJsonKeyValue(statusKey, jsonUtility.getJsonObjectByKey("citizenOtherThanIndia", primaryFatcaDetailObj)).equalsIgnoreCase("y")) {
                p.add(imgChecked);
            } else {
                p.add(imgUnchecked);
            }
            ...
            p = new Paragraph();
            if (jsonUtility.getJsonKeyValue(statusKey, jsonUtility.getJsonObjectByKey("residentOtherThanIndia", primaryFatcaDetailObj)).equalsIgnoreCase("y")) {
                p.add(imgChecked);
            } else {
                p.add(imgUnchecked);
            }
            ...
            p = new Paragraph();
            if (jsonUtility.getJsonKeyValue(statusKey, jsonUtility.getJsonObjectByKey("greenCardHolder", primaryFatcaDetailObj)).equalsIgnoreCase("y")) {
                p.add(imgChecked);
            } else {
                p.add(imgUnchecked);
            }
            ...
            Table lifeAssuredDetailDifferFromProposerDetails = this.getLifeAssuredDetailDifferFromProposer(imgChecked,imgUnchecked,insuredPersonBasicDetailObj,secondaryPersonalDetailObj,secondaryEmploymentDetailObj,secondaryFatcaDetailObj,otherSetOccupation, myself,innerProposer);
            ...
            planName = "IndiaFirst Life Accidental Death Benefit Rider (ADB)";
            planTerm = "";
            premiumPlayingTerm = "";
            premiumInstallment = "";
            sumAssured = "";
            ...
            p.add(" is applicable for IndiaFirst Life Long Guaranteed Income Plan & IndiaFirst Life Mahajeevan Plus Plan. ");
            p.add(new Text("\nIndiaFirst Life Waiver Of Premium Rider").setBold());
            p.add(" is applicable for IndiaFirst Life Smart Pay Plan, IndiaFirst Life Long Guaranteed Income Plan, " + "IndiaFirst Life Guaranteed Benefit Plan, IndiaFirst Life Mahajeevan Plus Plan, IndiaFirst Life Fortune Plus Plan & IndiaFirst Life Guarantee Of Life Dreams Plan.");
            table.addCell(new Cell().add(p).setBorder(Border.NO_BORDER));
            ...
            p.add("     No      ");
            p.add(imgUnchecked);
            p.add("     (Applicable for IndiaFirst Life Smart Pay Plan & IndiaFirst Life Mahajeevan Plus Plan)");
            table.addCell(new Cell().add(p).setBorder(Border.NO_BORDER));
            ...
            p.add(new Text("IndiaFirst Life Super Protection Plan").setBold());
            ...
            p.add(new Text("IndiaFirst Life Wealth Maximizer Plan, IndiaFirst Life Money Balance Plan, IndiaFirst Life Term with ULIP Plus and IndiaFirst Life Term with Unit Linked Insurance Plan").setBold());
            ...
            headingCell = new Cell();
            headingCell.setBackgroundColor(Color.GRAY, 100);
            p = new Paragraph("5. Details of Secondary Life Assured (If Joint Life option is chosen).  Only applicable for IndiaFirst Life Super Protection Plan");
            p.setBold();
            p.setFontKerning(FontKerning.YES);
            p.setFontColor(Color.WHITE);
            headingCell.add(p);
            ...
            Table secondaryLifeAssuredDetails = this.getSecondaryLifeAssuredDetails(applicationNumber, imgChecked, imgUnchecked, planDetailObj, insuredPersonBasicDetailObj, secondaryPersonalDetailObj, secondaryDocumentDetailObj, secondaryEmploymentDetailObj, secondaryFatcaDetailObj, otherSetOccupation, ageProofMap, buyFor, isOmniDoc,innerProposer,jsonUtility.getJsonKeyValue("insuredPhotoBase64",userData));
            ...
            if (jsonUtility.getJsonKeyValue(statusKey, familySufferObj).equalsIgnoreCase("y")) {
                p.add(imgChecked);
            } else {
                p.add(imgUnchecked);
            }
            p.add(yesKey);
            if (jsonUtility.getJsonKeyValue(statusKey, familySufferObj).equalsIgnoreCase("n")) {
                p.add(imgChecked);
            } else {
                p.add(imgUnchecked);
            }
            ...
            String appliedInsuranceStatus = jsonUtility.getJsonKeyValue(statusKey, jsonUtility.getJsonObjectByKey("appliedInsurance", primaryOtherDetailObj));
            ...
            for (JsonElement element : insuranceHeld) {
                ...
                insurancePolicies.addCell(objNom.get(statusKey).getAsString());
            }
            ...
            p.add("(including existing policies with IndiaFirst Life Insurance Co. Ltd.)(Details of " + "Secondary Life Assured (If Joint Life option is chosen). Only applicable for IndiaFirst Life Guaranteed Protection Plus Plan)");
            p.setFontKerning(FontKerning.YES);
            p.setFontColor(Color.WHITE);
            headingCell.add(p);
            table.addCell(new Cell().add(headingCell).setBorder(Border.NO_BORDER));
            p = new Paragraph("Have you ever applied for life insurance policies with IndiaFirst Life Insurance Co. Ltd and with other insurers? If yes, please give full details below, with present status and terms of acceptance " + "for all proposals/ policies applied:    ");
            appliedInsuranceStatus = jsonUtility.getJsonKeyValue(statusKey, jsonUtility.getJsonObjectByKey("appliedInsurance", secondaryOtherDetailObj));
            if (appliedInsuranceStatus.equalsIgnoreCase("y")) {
                p.add(imgChecked);
            } else {
                p.add(imgUnchecked);
            ...
            String heightInCm = "";
            try {
                heightInCm = pdfUtility.feetAndInchesToCms(Double.parseDouble(jsonUtility.getJsonKeyValue("feet", heightObj)), Double.parseDouble(jsonUtility.getJsonKeyValue("inch", heightObj)));
            } catch (Exception e) {
                logger.info("");
            }
            p = new Paragraph();
            ...
            p = new Paragraph();
            if (jsonUtility.getJsonKeyValue(statusKey, jsonUtility.getJsonObjectByKey("hazardous_activity", primaryLifestyleObj)).equalsIgnoreCase("y")) {
                p.add(imgChecked);
            } else {
                p.add(imgUnchecked);
            }
            p.add(yesKey);
            if (jsonUtility.getJsonKeyValue(statusKey, jsonUtility.getJsonObjectByKey("hazardous_activity", primaryLifestyleObj)).equalsIgnoreCase("n")) {
                p.add(imgChecked);
            } else {
                p.add(imgUnchecked);
            }
            ...
            p = new Paragraph();
            if (jsonUtility.getJsonKeyValue(statusKey, jsonUtility.getJsonObjectByKey("outOfIndia", primaryLifestyleObj)).equalsIgnoreCase("y")) {
                p.add(imgChecked);
            } else {
                p.add(imgUnchecked);
            }
            p.add(yesKey);
            if (jsonUtility.getJsonKeyValue(statusKey, jsonUtility.getJsonObjectByKey("outOfIndia", primaryLifestyleObj)).equalsIgnoreCase("n")) {
                p.add(imgChecked);
            } else {
                p.add(imgUnchecked);
            }
            ...
            String tobaccoStatus = jsonUtility.getJsonKeyValue(statusKey, tobaccoConsumptionObj);
            ...
            String alcoholConsStatus = jsonUtility.getJsonKeyValue(statusKey, alcoholConsumptionObj);
            ...
            String medicationStatus = jsonUtility.getJsonKeyValue(statusKey, medicationObj);
            ...
            String congenitalStatus = jsonUtility.getJsonKeyValue(statusKey, congenitalObj);
            ...
            String healthHistoryStatus = jsonUtility.getJsonKeyValue(statusKey, healthHistoryObj);
            ...
            String diagnosedHepatitisStatus = jsonUtility.getJsonKeyValue(statusKey, jsonUtility.getJsonObjectByKey("diagnosedHepatitis", primaryMedicalObj));
            ...
            String diagnosedStatus = jsonUtility.getJsonKeyValue(statusKey, diagnosedObj);
            ...
            String medicalInvestigationsStatus = jsonUtility.getJsonKeyValue(statusKey, medicalInvestigationsObj);
            ...
            String sufferedStatus = jsonUtility.getJsonKeyValue(statusKey, sufferedObj);
            ...
            String specialistDoctorTreatmentStatus = jsonUtility.getJsonKeyValue(statusKey, specialistDoctorTreatmentObj);
            ...
            String injuryIllnessStatus = jsonUtility.getJsonKeyValue(statusKey, injuryIllnessObj);
            ...
            String lostWeightstatus = jsonUtility.getJsonKeyValue(statusKey, lostWeightObj);
            ...
            String criminalConvictionsStatus = jsonUtility.getJsonKeyValue(statusKey, criminalConvictionsObj);
            ...
            String sufferedDiseaseStatus = jsonUtility.getJsonKeyValue(statusKey, sufferedDiseaseObj);
            ...
            medicalLifestyleQ.addCell(new Cell().add("b. Have you taken part, or do you have plans to take part, in any hazardous/ dangerous activity such as ballooning, mountain cycling, motorbike racing, boxing, gliding, diving, horse riding, martial " + "arts, motor racing, mountain climbing, parachuting, sailing, skiing, weight lifting, white water rafting, wrestling and/ or flying other than as a fare paying passenger on a licensed service or any other " + "hazardous/ dangerous activity which is not listed. If yes, please provide details in the special questionnaire which your advisor will provide.").setBorder(Border.NO_BORDER));
            p = new Paragraph();
            if (jsonUtility.getJsonKeyValue(statusKey, jsonUtility.getJsonObjectByKey("hazardous_activity", secondaryLifestyleObj)).equalsIgnoreCase("y")) {
                p.add(imgChecked);
            } else {
                p.add(imgUnchecked);
            }
            p.add(yesKey);
            if (jsonUtility.getJsonKeyValue(statusKey, jsonUtility.getJsonObjectByKey("hazardous_activity", secondaryLifestyleObj)).equalsIgnoreCase("n")) {
                p.add(imgChecked);
            } else {
                p.add(imgUnchecked);
            }
            ...
            medicalLifestyleQ.addCell(new Cell().add("c. Are you currently or do you intend to live or travel outside India for more than six months in a financial year? If yes, please provide full details of countries to be visited the purpose of visit and duration").setBorder(Border.NO_BORDER));
            p = new Paragraph();
            if (jsonUtility.getJsonKeyValue(statusKey, jsonUtility.getJsonObjectByKey("outOfIndia", secondaryLifestyleObj)).equalsIgnoreCase("y")) {
                p.add(imgChecked);
            } else {
                p.add(imgUnchecked);
            }
            p.add(yesKey);
            if (jsonUtility.getJsonKeyValue(statusKey, jsonUtility.getJsonObjectByKey("outOfIndia", secondaryLifestyleObj)).equalsIgnoreCase("n")) {
                p.add(imgChecked);
            } else {
                p.add(imgUnchecked);
            }
            ...
            tobaccoStatus = jsonUtility.getJsonKeyValue(statusKey, tobaccoConsumptionObj);
            p = new Paragraph("d. Have you smoked or used any form of tobacco in the past 12 months? If yes, please indicate in which form: \n");
            if (tobaccoStatus.equalsIgnoreCase("y") && tobaccoType.equalsIgnoreCase("Cigarette")) {
                p.add(imgChecked);
            } else {
            ...
            alcoholConsStatus = jsonUtility.getJsonKeyValue(statusKey, alcoholConsumptionObj);
            p = new Paragraph("e. Do you consume any form of alcohol? If yes, what type?: \n");
            if (alcoholConsStatus.equalsIgnoreCase("y") && alcoholType.equalsIgnoreCase("Beer")) {
                p.add(imgChecked);
            } else {
            ...
            String secondaryMedicationStatus = jsonUtility.getJsonKeyValue(statusKey, secondaryMedicationObj);
            p = new Paragraph();
            ...
            String secondaryCongenitalStatus = jsonUtility.getJsonKeyValue(statusKey, secondaryCongenitalObj);
            p = new Paragraph();
            ...
            String secondaryHealthHistoryStatus = jsonUtility.getJsonKeyValue(statusKey, secondaryHealthHistoryObj);
            p = new Paragraph();
            ...
            medicalLifestyleQ.addCell(new Cell().add("i. Do you suffer from or ever had any medical ailments such as Hepatitis B or C, or tuberculosis, psychiatric disorder, depression, colitis, or any other stomach problems, thyroid disorders, reproductive " + "organs, HIV AIDS or a related infection?").setBorder(Border.NO_BORDER));
            p = new Paragraph();
            diagnosedHepatitisStatus = jsonUtility.getJsonKeyValue(statusKey, jsonUtility.getJsonObjectByKey("diagnosedHepatitis", secondaryMedicalObj));
            if (diagnosedHepatitisStatus.equalsIgnoreCase("y")) {
                p.add(imgChecked);
            } else {
                p.add(imgUnchecked);
            ...
            String secondaryDiagnosedStatus = jsonUtility.getJsonKeyValue(statusKey, secondaryDiagnosedObj);
            p = new Paragraph();
            ...
            String secondaryMedicalInvestigationsStatus = jsonUtility.getJsonKeyValue(statusKey, secondaryMedicalInvestigationsObj);
            p = new Paragraph();
            ...
            String secondarySufferedStatus = jsonUtility.getJsonKeyValue(statusKey, secondarySufferedObj);
            p = new Paragraph();
            ...
            String secondarySpecialistDoctorTreatmentStatus = jsonUtility.getJsonKeyValue(statusKey, secondarySpecialistDoctorTreatmentObj);
            p = new Paragraph();
            ...
            String secondaryInjuryIllnessStatus = jsonUtility.getJsonKeyValue(statusKey, secondaryInjuryIllnessObj);
            p = new Paragraph();
            ...
            lostWeightstatus = jsonUtility.getJsonKeyValue(statusKey, secondaryLostWeightObj);
            ...
            String secondaryCriminalConvictionsStatus = jsonUtility.getJsonKeyValue(statusKey, secondaryCriminalConvictionsObj);
            p = new Paragraph();
            ...
            String secondarySufferedDiseaseStatus = jsonUtility.getJsonKeyValue(statusKey, secondarySufferedDiseaseObj);
            p = new Paragraph();
            ...
            String pregnantStatus = jsonUtility.getJsonKeyValue(statusKey, pregnantObj);
            ...
            String eIANumber = "";
            String irName = "";
            if (jsonUtility.getJsonKeyValue(statusKey, existingInsuranceAccountObj).equalsIgnoreCase("y")) {
            ...
            if (jsonUtility.getJsonKeyValue(statusKey, existingInsuranceAccountObj).equalsIgnoreCase("n")) {
            ...
            /////
            p = new Paragraph();
            p.add("Secondary Life to be Assured signature (if Joint Life option is chosen.\n" + "Only applicable for IndiaFirst Life Guaranteed Protection Plus Plan)");
            table.addCell(new Cell().add(p).setBorder(Border.NO_BORDER));

            String laName = jsonUtility.getJsonKeyValue("fullName", insuredPersonBasicDetailObj);
            String laPlace = jsonUtility.getJsonKeyValue("city", secondaryPersonalDetailObj);
...
//            JsonObject haveDisabilityObj = jsonUtility.getJsonObjectByKey("have_disability", medicalDisabilityObj);
            ...
            signatureDeclarants.addCell(new Cell(2,4).add("Signature or thumb impression of the secondary life to be assured (if Joint Life option is chosen. Only applicable for IndiaFirst Life Guaranteed Protection Plus Plan)").setBorder(Border.NO_BORDER));
            table.addCell(new Cell().add(signatureDeclarants).setBorder(Border.NO_BORDER));
            //////NEW section ended/////////////////
            ...
            if (isOmniDoc) {
                p = new Paragraph();
                p.add(imgChecked);
                String primaryMobileNo = jsonUtility.getJsonKeyValue("mobileNumber", jsonUtility.getJsonObjectByKey(primaryKey, personalDetailObj));
                if (countryCode.equalsIgnoreCase("91")) {
                    p.add(new Text("   Validated through the OTP sent to " + "registered mobile no."));
    ...
    public Table getSecondaryLifeAssuredDetails(String applicationNo,Image imgChecked,Image imgUnchecked,JsonObject planDetailObj,JsonObject insuredPersonBasicDetailObj,JsonObject secondaryPersonalDetailObj,JsonObject secondaryDocumentDetailObj,JsonObject secondaryEmploymentDetailObj,JsonObject secondaryFatcaDetailObj,Set<String> otherSetOccupation,Map<String, String> ageProofMap,String buyFor,boolean isOmniDoc,Table innerProposer,String insuredBase64Photo){
        ...
        if ((!buyFor.equalsIgnoreCase("MYSELF")) && planCode.equalsIgnoreCase("T64")) {
            ...
            byte []photoBytes = Base64.getDecoder().decode(insuredBase64Photo.getBytes());
            ImageData dataPhoto = ImageDataFactory.create(photoBytes);
            Image photoImg = new Image(dataPhoto);
            photoImg.setHeight(150);
            photoImg.setWidth(150);
            ...
            contactTable.addCell(new Cell().add("Pin Code:  ").setBorder(Border.NO_BORDER).setTextAlignment(TextAlignment.CENTER));
            contactTable.addCell(new Cell().add(pdfUtility.createDataTable(pinCode,"00000000")).setBorder(Border.NO_BORDER));
            ...
            p=new Paragraph("Age Proof");
            p.add(new Text(" (Life Assured):    ").setFontSize(5F));
            otherDetails.addCell(new Cell().add(p).setTextAlignment(TextAlignment.CENTER).setBorder(Border.NO_BORDER));
            ...
            addressBlock.addCell(new Cell().add(pdfUtility.createDataTable(address2,"0000000000000000000000000000000")).setBorder(Border.NO_BORDER));
            addressBlock.addCell(new Cell().add(pdfUtility.createDataTable(address3,"0000000000000000000000000000000")).setBorder(Border.NO_BORDER));
            addressBlock.addCell(new Cell().add(pdfUtility.createDataTable("","0000000000000000000000000000000")).setBorder(Border.NO_BORDER));
            addressBlock.addCell(new Cell().add(pdfUtility.createDataTable(city,"0000000000000000000000000000000")).setBorder(Border.NO_BORDER));
            addressBlock.addCell(new Cell().add(pdfUtility.createDataTable(state,"0000000000000000000000000000000")).setBorder(Border.NO_BORDER));
            proposerMergedcell.add(addressBlock).setBorder(Border.NO_BORDER);
            lifeAssuredDetails.addCell(proposerMergedcell).setVerticalAlignment(VerticalAlignment.MIDDLE);
    ...
    public Table getLifeAssuredDetailDifferFromProposer(Image imgChecked,Image imgUnchecked,JsonObject insuredPersonBasicDetailObj,JsonObject secondaryPersonalDetailObj,JsonObject secondaryEmploymentDetailObj,JsonObject secondaryFatcaDetailObj,Set<String> otherSetOccupation,boolean myself,Table innerProposer){
        Table lifeAssuredDetails = new Table(2);
        lifeAssuredDetails.setBorder(Border.NO_BORDER);
        String lifeAssuredFullName = "";
        ...
        if (!myself) {
            ...
            String maritalStatus = jsonUtility.getJsonKeyValue("maritalstatus", secondaryPersonalDetailObj);
            DateTimeFormatter dateTimeFormatter = DateTimeFormatter.ofPattern("dd-MM-yyyy");
            LocalDate currentDate = LocalDate.now();
            LocalDate birthDate = LocalDate.parse(lifeaAssuredDoB);
            ...
            String permanentaddressline1 = jsonUtility.getJsonKeyValue("permanentaddressline1", secondaryPersonalDetailObj);
            if (!permanentaddressline1.isEmpty()) {
                if (permanentaddressline1.length() <= 10) {
                    permanentaddressline1 += "                                        ";
                } else if (permanentaddressline1.length() > 10 && permanentaddressline1.length() <= 20) {
                    permanentaddressline1 += "                              ";
            ...
            String permanentaddressline2 = jsonUtility.getJsonKeyValue("permanentaddressline2", secondaryPersonalDetailObj);
            ...
            String permanentaddressline3 = jsonUtility.getJsonKeyValue("permanentaddressline3", secondaryPersonalDetailObj);
            ...
            Table addressBlock = new Table(1);
            addressBlock.addCell(new Cell().add("Communication Address of the Life Assured (Address to which policy document will be dispatched)").setBorder(Border.NO_BORDER));
            ...
            proposerMergedcell = new Cell(1, 2);
            float[] pointColumnWidths = new float[]{200F, 600F, 200F, 420F};
            contactTable = new Table(pointColumnWidths);
            String emailId=jsonUtility.getJsonKeyValue("emailId", secondaryPersonalDetailObj);
            String landLine="";
            p=new Paragraph("Email ID* ");
            ...
            if (!panCardNo.isEmpty()) {
                tableCodes = codeTable(panCardNo, pointColumnWidths);
...
//                otherDetails.addCell(new Cell().add(imgUnchecked).setBorder(Border.NO_BORDER));
            ...
            lifeAdditionalDetails = new Table(2);
            proposerMergedcell = new Cell(1, 2);
            proposerMergedcell.add(contactTable);
            proposerMergedcell.setBorder(Border.NO_BORDER);
            ...
            //p.add(imgUnchecked);
            otherDetails.addCell(new Cell().add(p).setTextAlignment(TextAlignment.CENTER).setBorder(Border.NO_BORDER));
            otherDetails.addCell(new Cell().add(pdfUtility.createDataTable("","000000000")).setBorder(Border.NO_BORDER));
            otherDetails.addCell(new Cell().add(new Cell().add(" ").setUnderline()).setBorder(Border.NO_BORDER));
            lifeAssuredDetails.addCell(new Cell(1, 2).add(otherDetails).setBorder(Border.NO_BORDER));
